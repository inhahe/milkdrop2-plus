...
Fork additions are licensed under the [MIT License](LICENSE-ADDITIONS.txt) by Richard Albert Nichols III (Inhahe). Original code retains its MPL-2.0 / BSD-3-Clause licenses.
...
This fork by Richard Albert Nichols III (Inhahe) adds category selection, preset management, and favorites. Built with the assistance of [Claude Code](https://claude.ai/code) using Claude Opus 4.6.
